    ...
    <header class="signup__header">
        <div class="container">
            <div class="signup__header-content">
                ...
                <a href="<?php print site_url()?>frontend/signin" class="btn" style="background:#27367f;border-radius:3px;color: #fff;">Sign In</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="signup__container">
                ...
                <div class="signup__head">
                    <h3>Create a New Blogs Account</h3>
                    <!--<p>By singin up you can start posting.</p>-->
                </div>
