      ...
      <div class="main-panel">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <p class="mb-md-0" style="font-size: 18px;">Dashboard</p>
                    <h2 style="font-size: 18px;">Welcome back, <?php print $this->session->userdata('ci_seesion_key')['first_name']; ?></h2>
                  </div>
                  <!--<div class="d-flex">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2020 <a href="#" target="_blank">Blogs</a>. All rights reserved.</span>
