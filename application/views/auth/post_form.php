      ...
      <div class="main-panel">        
        ...
        <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                      <span class="card-title blog-title" style="font-size:18px;">Add Post</span><a href="<?php print site_url()?>auth/post_list" style="float:right;" class="add_link">Back to Post List</a>
                  </div>
                </div>
              </div>
          </div>
                    ...
                    <div class="form-group">
                      <div class="row">
                       <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="post_title" id="post_title" value="<?php echo set_value('post_title') ?>" placeholder="Post Title">
                        <span class="help-block"><?php echo form_error('post_title') ?></span>
                       </div>
                       <div class="col-6">
                         <label for="exampleInputName1">Author Name</label>
                         <input type="text" class="form-control" name="post_author" id="post_author" value="<?php echo set_value('post_author') ?>" placeholder="Author Name">
                         <span class="help-block"><?php echo form_error('post_author') ?></span>
                       </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <span class="help-block"><?php echo form_error('describe') ?></span>
                    </div>    
